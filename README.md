...
Lozza is a UCI chess engine written in Javascript without WASM. It's easily deployed using a web worker and can also be used with traditional chess user interfaces like Cutechess and Arena.
